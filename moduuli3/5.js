...
const header = document.querySelectorAll('#pictures h2');
const caption = document.querySelectorAll('#pictures figcaption');
const paragraph = document.querySelectorAll('#pictures p');
const image = document.querySelectorAll('#pictures img');

for (let i = 0; i < 9; i++) {
  header[i].innerText = picArray[i].title;
  caption[i].innerText = picArray[i].caption;
  paragraph[i].innerText = picArray[i].description;
  image[i].src = picArray[i].image.medium;
}